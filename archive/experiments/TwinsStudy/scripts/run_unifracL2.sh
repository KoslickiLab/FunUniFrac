...
for treeType in "AAI" "motifs"; do
	...
	for dirName in "DZ" "MZ" "merged"; do
		for kSize in 5 7 11 15; do
			...
			OutFile="${dirName}_pw_fu_${treeType}_scale_${scale}_k_${kSize}_f_unique_weighted_L2.np"
			...
			OutFile="${dirName}_pw_fu_unweighted_${treeType}_scale_${scale}_k_${kSize}_f_unique_weighted_L2.np"
