        ...
        for method in ["AAI", "motifs", "uniform"]:
            for kSize in [5, 7, 11, 15]:
                for approach in ["weighted", "unweighted"]:
                    ...
                    x1, x2 = 0, 1
                    y, h, col = max_val*(1 + 0.2), 0.01*max_val*(1 + 0.2), 'k'
                    ...
                    x1, x2 = 0, 2
                    y, h, col = max_val*(1 + 0.3), 0.01*max_val*(1 + 0.2), 'k'
                    ...
                    plt.savefig(f"output/zygosity_boxplot_paired_{method}_ksize_{kSize}_{approach}_scale_"
                                f"{scale}_{metric}.png",
                                dpi=300,
                                bbox_inches='tight')
                    plt.show()
