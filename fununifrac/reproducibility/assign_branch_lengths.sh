...
python ../compute_edges.py -d "../../fununifrac/reproducibility/"$ko_dm_file -e "d../../fununifrac/reproducibility/$kegg_tree_no_lengths" "../../fununifrac/reproducibility/$A_matrix" -b ko00001 -o "../../fununifrac/reproducibility/data/$rand_output" --force --distance
